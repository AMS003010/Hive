        ...
        <>
            ...
            <div className="board-layout h-[31rem] border border-gray-200 mx-4 rounded-3xl overflow-hidden shadow-lg">
                <div className="flex justify-center items-center gap-2 w-max m-4">
                    <div className="text-gray-500 font-extralight p-3 border rounded-xl w-max bg-gray-50 shadow-md text-center cursor-pointer hover:bg-gray-200">
                    ...
                    <div className="text-xl text-gray-500 font-extralight p-2 px-6 border rounded-xl w-max bg-gray-50 shadow-md text-center">CodeFusion 2024</div>
                </div>
